...
exports.command = "pull <project>";
exports.desc = "pull <project>";
...
const handler = (argv) => {
    ...
    if (fs_1.default.existsSync(path_1.default.join(os_1.default.tmpdir(), "genv", `${project}.json`))) {
        ...
        const envs = (0, toEnv_1.toEnv)(json);
        fs_1.default.writeFileSync(path_1.default.join(process.cwd(), ".env"), envs, {
            encoding: "utf8",
        });
    }
    process.exit(0);
